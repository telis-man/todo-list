...
function createTaskItem(taskText) {
  ...
  // listItem.setAttribute('data-testid', 'liTestId')
  const textNode = document.createTextNode(taskText)
  textNode.setAttribute('data-testid', 'liTestId')
...
// before each teste iskvieti funkcija

console.log(createTaskItem('Belekas seniuk').textNode.textContent)
