...
})({"bNTgH":[function(require,module,exports) {
...
loginForm.addEventListener("submit", (e)=>{
    ...
    const user = (0, _script.getUser)(username);
    if (!user) {
        (0, _script.showAlert)("Username not found.", "error", "login");
        return;
    }
    if (user.password !== password) {
        (0, _script.showAlert)("Incorrect password.", "error", "login");
        return;
    }
    loggedInUser = user;
